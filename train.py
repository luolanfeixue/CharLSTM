...
from data_core import TextConverter, batch_generator
...
def main(_):
	...
	arr = converter.get_arr(text)
	g = batch_generator(arr, FLAGS.num_seqs, FLAGS.num_steps)
	
	model = CharRNN(converter.vocab_size, num_seqs=FLAGS.num_seqs, num_steps=FLAGS.num_steps, lstm_size=FLAGS.lstm_size,
